...
if __name__ == "__main__":
    ...
    sd_df = get_bootstrap_index_df(trn_df, 2, 5, 10)
    se_df = get_bootstrap_index_df(trn_df1, 2, 5, 10)

    sd_df.to_csv(r'bootstrap_index_daejeon_weekdays_20240418.csv', index=False)
    se_df.to_csv(r'bootstrap_index_daejeon_weekends_20240418.csv', index=False)
