...
if __name__ == "__main__":
    ...
    week_obj = uu.load_gpickle(r'results/results/weekdays/daejeon/50_4_0317_step23_4.0_positive_4_False_Ridge.pickle')['pred_y']
    comparison_obj = uu.load_gpickle(r'[TAB 7.]daejeon_comparison_week_holy_optimal_pred_y_revision1_0317.pickle')['weekdays']

    index_df = pd.read_csv(r'preprocess/daejeon/index_daejeon_tst_weekdays.csv')
    ...
    index_df.to_csv(r'daejeon_real_pred_weekdays.csv', index=False)
