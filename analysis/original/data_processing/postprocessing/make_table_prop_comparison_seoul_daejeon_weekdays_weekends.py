...
metric_sd = get_group_metric_df_extreme(sd_df[['real','pred','AdaBoost','AdaBoost_RT','GBM','XGBoost','MBoost','LADBoost']], grouper_idxs)
...
metric_se = get_group_metric_df_extreme(se_df[['real','pred','AdaBoost','AdaBoost_RT','GBM','XGBoost','MBoost','LADBoost']], grouper_idxs)
...
pd.concat([metric_sd, metric_se], axis=0).groupby(['Group','Model','type']).mean().unstack().loc[
    [('Group1','pred'),('Group1','AdaBoost'),('Group1','AdaBoost_RT'),('Group1','GBM'), ('Group1','XGBoost'),('Group1','MBoost'),('Group1','LADBoost'),
     ...
     ('Whole','pred'),('Whole','AdaBoost'),('Whole','AdaBoost_RT'),('Whole','GBM'), ('Whole','XGBoost'),('Whole','MBoost'),('Whole','LADBoost')]].to_csv(r'prediction_performance_seoul_prop_comparison_weekdays_weekends.csv')
...
metric_dd = get_group_metric_df_extreme(dd_df[['real','pred','AdaBoost','AdaBoost_RT','GBM','XGBoost','MBoost','LADBoost']], grouper_idxs)
...
metric_de = get_group_metric_df_extreme(de_df[['real','pred','AdaBoost','AdaBoost_RT','GBM','XGBoost','MBoost','LADBoost']], grouper_idxs)
...
pd.concat([metric_dd, metric_de], axis=0).groupby(['Group','Model','type']).mean().unstack().loc[[('Group1','pred'),('Group1','AdaBoost'),('Group1','AdaBoost_RT'),('Group1','GBM'), ('Group1','XGBoost'),('Group1','MBoost'),('Group1','LADBoost'),
     ('Group2','pred'),('Group2','AdaBoost'),('Group2','AdaBoost_RT'),('Group2','GBM'), ('Group2','XGBoost'),('Group2','MBoost'),('Group2','LADBoost'),
     ('Group3','pred'),('Group3','AdaBoost'),('Group3','AdaBoost_RT'),('Group3','GBM'), ('Group3','XGBoost'),('Group3','MBoost'),('Group3','LADBoost'),
     ('Whole','pred'),('Whole','AdaBoost'),('Whole','AdaBoost_RT'),('Whole','GBM'), ('Whole','XGBoost'),('Whole','MBoost'),('Whole','LADBoost')]].to_csv(r'prediction_performance_daejeon_prop_comparison_weekdays_weekends.csv')
