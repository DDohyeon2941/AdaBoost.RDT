...
#temp_df = pd.read_csv(r'y_val_cdf_weight_seoul_weekdays_model8_lasso_avg_threshold_ratio.csv')
...
grouper_idxs = get_grouper_index(concated_df.real.values, 4, 40)

#%%
get_group_metric_df_extreme(concated_df, grouper_idxs).to_csv(r'prediction_performance_seoul_weekends_model8_lasso_thr_avg_threshold_ratio_alpha.csv', index=False)
