...
if __name__ == "__main__":
    ...
    week_dir = r'optimal_comparison_weekdays/seoul'
    week_dict = {}
...
#%%
    ...
    holy_dir = r'optimal_comparison_weekends/seoul'
    holy_dict = {}
    ...
    uu.save_gpickle('seoul_comparison_week_holy_optimal_pred_y_revision1_0317.pickle', {'weekdays':week_dict, 'weekends':holy_dict})
