...
if __name__ == "__main__":
    ...
    #final_result_df.to_csv(r'prediction_performance_seoul_daejeon_weekdays_weekends_bootstrap_5.csv', index=False)

    final_result_df.groupby(['city_name','day_type','Group','Model']).mean().drop(columns='rs').loc['daejeon']
