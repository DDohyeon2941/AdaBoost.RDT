...
if __name__ == "__main__":
    temp_df = pd.read_csv(r'prediction_performance_seoul_daejeon_weekdays_weekends_bootstrap_over_extreme_5.csv')
    city_name = 'daejeon'
    ...
    seoul_df.to_csv(r'prediction_performance_for_latex_bootstrap_%s_over_extreme.csv'%(city_name))
    ...
    file1 = open(r'prediction_performance_bootstrap_over_extreme_%s_latex.txt'%(city_name), "r").readlines()
    file1 = [xx.replace('\n', '') for xx in file1]
